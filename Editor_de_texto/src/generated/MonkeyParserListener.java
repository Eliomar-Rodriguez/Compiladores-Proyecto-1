...
public interface MonkeyParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code id_Mky}
	 * labeled alternative in {@link MonkeyParser#identifier}.
	 * @param ctx the parse tree
	 */
	void enterId_Mky(MonkeyParser.Id_MkyContext ctx);
	/**
	 * Exit a parse tree produced by the {@code id_Mky}
	 * labeled alternative in {@link MonkeyParser#identifier}.
	 * @param ctx the parse tree
	 */
	void exitId_Mky(MonkeyParser.Id_MkyContext ctx);
}