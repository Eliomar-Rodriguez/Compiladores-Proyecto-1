...
letStatement          	locals[int storageIndex = 0]
                        : identifier ASSIGN expression (PyCOMA | )      #lt_asign_Mky;
...
functionParameters	: identifier moreIdentifiers                        #funcParams_Mky;
moreIdentifiers	: (COMA identifier)*                                    #moreIdentifiers_Mky;
